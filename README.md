...
### Упити 
<br />
1.  Пронаћи све кориснике који су рођени после задате године.
2.  Добавити укупан број објава за корисника са задатом имејл адресом.
3.  Пронаћи све објаве који су направљени од стране корисника са задатом имејл адресом.
4.  Пронаћи топ 5 корисника по броју објава.
5.  Добавити све кориснике и њихове објаве који у биографији имају кључну реч.
6.  Додавање новог корисника.
7.  Измена података корисника.
8.  Брисање корисника.
9.  Добавити све кориснике који у својима постовима имају неку кључну реч. (Subquery)
10. Добавити све тагове објава који у себи имају неку кључну реч.
<br />
