...
class Benchmark:
    ...
    def execute_first_query(self, times):
        ...
        for i in range(0, times):
            ...
            users = self.user_repository.get_users_born_after()
    ...
    def execute_fifth_query(self, times):
        ...
        for i in range(0, times):
            ...
            self.user_repository.add_user(
                "Pera", "Petrovic", "perica@example.com", datetime.date(2000, 1, 1))
    ...
    def execute_eigth_query(self, times):
        ...
        for i in range(0, times):
            ...
            result = self.tag_repository.get_tags_by_user(
                "user199@example.com")
    ...
    def execute_tenth_query(self, times):
        ...
        for i in range(0, times):
            ...
            result = self.profile_repository.delete_profiles_by_phone_number(
                "87")
